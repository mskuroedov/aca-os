...
import MedicPage from '../components/schools/school/medic/Page';
...
import TournamentsListPage from '../components/tournamentsList/TournamentsListPage';
import SportsmenListPage from '../components/sportsman/list/SportsmanListPage';

export const history = createHistory();

export const routes = {
  schoolsPage: () => '/schools',
  schoolPage: (schoolId, view) => `/schools/${schoolId}/${view ? view : ''}`
};
