...
const options = ["ДЮСШ №34", "СДЮШОР №129"];
const optionsMenu = [
  {
    id: 1,
    link: "/",
      ...
      <div>
        <AppBar position="static">
          <Toolbar className="header">
            ...
            <div>
              <Button onClick={this.handleClick} className={classes.lkBtn}>
                <span className="xs-hidden">{this.props.username}</span>
                <Avatar
                  alt="Adelle Charles"
          ...
          <Toolbar className="header xs-hidden">
            <div className="header__nav ">
              ...
              <NavLink activeClassName="active" to={routes.schoolsPage()}>
                Школы
              </NavLink>
              <NavLink activeClassName="active" to="/sportsman">
                Спортсмены
              </NavLink>
              ...
              <NavLink activeClassName="active" to="/libraries">
                Библиотека
              </NavLink>
