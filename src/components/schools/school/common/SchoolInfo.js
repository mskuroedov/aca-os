        ...
        <Grid container spacing={16}>
          <Grid item xs={12} lg={8}>
            ...
            >
              ...
              >
                Вы можете оформить заявку на обучение в СДЮСШ «Ак Барс» и ДЮСШ
                «Динамо» на сайте академии «Ак Барс» имени Ю. И. Моисеева
              </Typography>
              <Typography
                type="body1"
                gutterBottom
                className={classes.primaryBigText}
                style={{ marginTop: 12 }}
              >
                <Icon className={classes.icon}>link</Icon>
                <a href="https://akbars.academy" className={classes.link}>
                  akbars.academy
                </a>
              </Typography>
              ...
              <ContactUs open={this.state.open} onClose={this.handleClose} />
              <PaperMenu />
            </Paper>
          </Grid>
          <Grid item xs={12} lg={4}>
            ...
            >
              ...
              <Typography
                type="body1"
                gutterBottom
                className={classNames(classes.primaryText, classes.textGray)}
                style={{
                  marginTop: 17,
                  marginBottom: 33
                }}
              ...
              <Grid container spacing={16}>
                <Grid item xs={2} style={{ paddingTop: 0 }}>
                  <Icon className={classes.icon}>phone_android</Icon>
                </Grid>
                <Grid
                  item
                  xs={10}
          ...
          <Grid item xs={12}>
            ...
            >
              <Typography type="body1" className={classes.primaryText}>
                Школа №1 основана в январе 2017 года. Деятельность школы
                направлена на всестороннее развитие юных хоккеистов: мы
                заботимся не только о развитии технических навыков молодых
                игроков, но и о гармоничном развитии личности в физическом,
                психологическом и социальном аспектах.
              </Typography>
              <Button
                color="primary"
                className={classes.button}
...
export default withRouter(withStyles(styles)(SchoolInfo));
