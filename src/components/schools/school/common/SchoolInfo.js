                ...
                >
                    <Grid item xs={8}>
                        ...
                        <Paper classes={{
                            ...
                            <Typography type="body1" gutterBottom className={classes.primaryBigText} style={{marginTop:12}}>
                                <Icon className={classes.icon}>link</Icon><a href="https://akbars.academy" className={classes.link}>akbars.academy</a>
                            </Typography>

                            <Typography type="body1" gutterBottom className={classes.primaryText} style={{marginTop:30}}>
                            ...
                            <Button raised color='primary' className={classes.button} >Подать заявку на обучение</Button><Button color='primary' className={classes.button}>Написать
                            сообщение</Button>
                        </Paper>
                    </Grid>
                    <Grid item xs={4}>
                        ...
                        <Paper className={classNames(classes.textCentered, classes.paper)} style={{paddingLeft:60,paddingRight:60}}>
                            <Avatar
                                alt="Adelle Charles"
                            ...
                            <Typography type="body1" gutterBottom className={classNames( classes.primaryText,classes.textGray)} style={{
                                marginTop:17,marginBottom:33}}>

                                Директор школы
                            </Typography>
                            <Grid container>
                                <Grid item xs={2}><Icon className={classes.icon}>phone_android</Icon></Grid>
                                <Grid item xs={10} style={{verticalAlign:'center'}}>
                                    <Typography type="body1" gutterBottom className={classes.primaryText} style={{textAlign:'left'}}>

                                        +7 920 751-165-53
                                    </Typography>
                                </Grid>
                                <Grid item xs={2}><Icon className={classes.icon}>email</Icon></Grid>
                                <Grid item xs={10}>
                                    <Typography type="body1" gutterBottom className={classes.primaryText} style={{textAlign:'left'}}>
                                        <a href="" className={classes.link} style={{marginLeft:0}}>info@akbars.academy</a>
                                    </Typography>
                                </Grid>
                            </Grid>
                    ...
                    <Grid item xs={12}>
                        ...
                        <Paper classes={{
                            ...
                            <Button color='primary' className={classes.button} style={{padding:0,marginLeft:-7}}>подробнее</Button>
                        </Paper>
