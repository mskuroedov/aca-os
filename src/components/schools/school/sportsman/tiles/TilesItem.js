        ...
        <Paper className={classnames('Paper', classes.paper)}>
          ...
          <Grid container className={classes.infoContainer}>
            <Grid item className={classes.info}>
              ...
              <Typography className={classes.infoVal}>2000</Typography>
              <Typography className={classes.infoTitle}>Год набора</Typography>
              <Typography className={classes.infoVal}>2016</Typography>
              <Typography className={classes.infoTitle}>Группа</Typography>
            ...
            <Grid item>
              <Typography className={classes.infoTitle}>Амплуа</Typography>
              <Typography className={classes.infoVal}>Вратарь</Typography>
            </Grid>
          </Grid>
          <PaperMenu />
        </Paper>
