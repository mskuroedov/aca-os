        ...
        <Grid container spacing={16}>
          <Grid item xs={12} lg={6}>
            ...
            <Paper className={classes.paper} style={{ marginBottom: 24 }}>
              <Grid container spacing={16}>
                <Grid item xs={2} lg={1}>
                  <Icon className={classes.iconGray}>location_on</Icon>
                </Grid>
                <Grid item xs={10} lg={11}>
                  <Typography className={classes.mainText}>
                    г. Казань, ул. Петербургская, д. 37, РТ, 420107
                  </Typography>
                </Grid>
                <Grid item xs={2} lg={1}>
                  <Icon className={classes.iconGray}>phone</Icon>
                </Grid>
                <Grid item xs={10} lg={11}>
                  <Typography className={classes.mainText}>
                    {" "}
                ...
                <Grid item xs={2} lg={1}>
                  <Icon className={classes.iconGray}>email</Icon>
                </Grid>
                <Grid item xs={10} lg={11}>
                ...
                <Grid item xs={2} lg={1}>
                  <Icon className={classes.iconGray}>link</Icon>
                </Grid>
                <Grid item xs={10} lg={11}>
                  <Link to="#" className={classes.link}>
                    akbars.academy
            ...
            <Paper className={classes.paper}>
              <Grid container spacing={8}>
                ...
                <Grid item xs={12} lg={6}>
                  ...
                  <Link to="/schools/1/schedule" className={classes.link}>
                    По расписанию
                  </Link>
                </Grid>
              </Grid>
            ...
            <Paper className={classes.paper}>
              <Grid container spacing={8}>
                <Grid item xs={12} style={{ marginBottom: 8 }}>
                  <Typography className={classes.mainText}>
                    ООО «Академия хоккея Ак Барс» имени Ю. И. Моисеева
                  </Typography>
                </Grid>
                <Grid item style={{ marginRight: 55 }}>
                  ...
                  <Typography className={classes.mainText}>
                    г. Казань, ул. Карла Маркса, д. 71, РТ, 420045
                  </Typography>
                </Grid>
                <Grid item style={{ marginRight: 55 }}>
