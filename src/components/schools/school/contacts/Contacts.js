...
const styles = theme => ({
    ...
    link:{
        lineHeight:1.6,
        color:'rgba(0,117,94,1)',
        transition:'all 0.4s',
        fontSize:16,
        '&:hover':{
            transition:'all 0.4s',
            color:'rgba(0,117,94,0.5)'
        }
    }
                ...
                <Grid container>
                    <Grid item xs={8}>
                        ...
                        <Paper className={classes.paper}>
                            <Grid container>
                                <Grid item><Icon className={classes.iconGray}>location_on</Icon></Grid>
                                <Grid item xs={11}>
                                    <Typography className={classes.mainText}>г. Казань, ул. Петербургская, д. 37, РТ, 420107</Typography>
                                </Grid>
                                <Grid item><Icon className={classes.iconGray}>phone</Icon></Grid>
                                <Grid item xs={11}>
                                    <Typography className={classes.mainText}> (+7 843) 221-81-10</Typography>
                                </Grid>
                                <Grid item><Icon className={classes.iconGray}>email</Icon></Grid>
                                <Grid item xs={11}>
                                    <Link to='#' className={classes.link}>info@akbars.academy</Link>

                                </Grid>
                                <Grid item><Icon className={classes.iconGray}>link</Icon></Grid>
                                <Grid item xs={11}>
                    ...
                    <Grid item xs={4} >
                        ...
                        <Paper className={classes.paper} style={{minHeight:207}}>
                            <Typography className={classes.mainText}>Администрация работает по будням с 8 до 18, суббота и воскресенье — выходные дни.
                                Тренеры работают по <Link to='#' className={classes.link}>расписанию</Link>.</Typography>
                        </Paper>
                    </Grid>
                    <Grid item xs={12}>
